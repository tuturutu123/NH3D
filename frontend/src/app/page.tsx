...
export default function Home() {
  ...
  if (loading) return <div className="flex justify-center items-center h-screen bg-gray-50 dark:bg-[#0f172a]"><div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#324b3b]"></div></div>;
  ...
  return (
    <div className="bg-[#faf9f6] dark:bg-[#0f172a] min-h-screen">
      ...
      <section className="relative py-12 md:py-32 overflow-hidden border-b border-[#e5e2d6] dark:border-gray-800">
        ...
        <div className="absolute inset-0 z-10 bg-linear-to-r from-white/80 via-white/50 to-transparent dark:from-[#0f172a]/90 dark:via-[#0f172a]/60"></div>
      ...
      <section className="bg-white dark:bg-[#111827] py-6 border-b border-[#e5e2d6] dark:border-gray-800">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="flex flex-col sm:flex-row sm:flex-wrap justify-between items-center gap-4 text-sm font-medium text-gray-700 dark:text-gray-300">
            <div className="flex items-center gap-3"><Truck className="h-5 w-5 text-[#7d6f5f] dark:text-[#6ba368]" /><span>Envíos rápidos<br/><span className="text-xs text-gray-500 font-normal">en Villa Mercedes</span></span></div>
            <div className="hidden md:block w-px h-10 bg-gray-200 dark:bg-gray-700"></div>
            <div className="flex items-center gap-3"><ShieldCheck className="h-6 w-6 text-[#7d6f5f] dark:text-[#6ba368]" /><span>Pagos seguros<br/><span className="text-xs text-gray-500 font-normal">y protegidos</span></span></div>
            <div className="hidden md:block w-px h-10 bg-gray-200 dark:bg-gray-700"></div>
            <div className="flex items-center gap-3"><Star className="h-6 w-6 text-[#7d6f5f] dark:text-[#6ba368]" /><span>Productos<br/><span className="text-xs text-gray-500 font-normal">de calidad</span></span></div>
            <div className="hidden md:block w-px h-10 bg-gray-200 dark:bg-gray-700"></div>
            <div className="flex items-center gap-3"><Phone className="h-6 w-6 text-[#7d6f5f] dark:text-[#6ba368]" /><span>Atención<br/><span className="text-xs text-gray-500 font-normal">personalizada</span></span></div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-3 sm:flex sm:overflow-x-auto pb-4 gap-4 hide-scrollbar">
            {categorias.map((cat) => (
              <a key={cat.id} href={`#cat-${cat.id}`} className="flex flex-col items-center gap-3 min-w-25 group">
                <div className="w-24 h-24 rounded-2xl bg-white dark:bg-gray-800 border border-[#e5e2d6] dark:border-gray-700 shadow-sm flex items-center justify-center p-3 group-hover:border-[#324b3b] dark:group-hover:border-[#6ba368] transition-colors overflow-hidden">
                  <img 
      ...
      <section className="py-8" id="ofertas">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-[#5a6b5a] dark:bg-[#2d4a35] rounded-2xl p-6 text-white relative overflow-hidden h-48 flex flex-col justify-center">
            ...
            <div className="bg-[#f0ece1] dark:bg-[#1e293b] rounded-2xl p-6 text-[#2a3c2e] dark:text-gray-100 relative overflow-hidden h-48 flex flex-col justify-center border border-[#e5e2d6] dark:border-gray-700">
              <h3 className="font-bold text-xl uppercase leading-tight mb-1">2 Yerbas<br/>CBSé 500g</h3>
              <p className="text-xs text-gray-600 dark:text-gray-400 mb-3">Tradicional o Silueta</p>
              <p className="font-bold text-2xl text-[#b4483a]">$7.990</p>
            </div>
            <div className="bg-[#f8f4e6] dark:bg-[#1e293b] rounded-2xl p-6 text-[#2a3c2e] dark:text-gray-100 relative overflow-hidden h-48 flex flex-col justify-center border border-[#e5e2d6] dark:border-gray-700">
              <h3 className="font-bold text-xl uppercase leading-tight mb-1">Termo<br/>Stanley 1L</h3>
              <p className="text-xs text-gray-600 dark:text-gray-400 mb-3">Clásico verde</p>
              <p className="font-bold text-2xl">$32.990</p>
            </div>
            <div className="bg-[#f7eedd] dark:bg-[#1e293b] rounded-2xl p-6 text-[#2a3c2e] dark:text-gray-100 relative overflow-hidden h-48 flex flex-col justify-center border border-[#e5e2d6] dark:border-gray-700">
              <h3 className="font-bold text-xl uppercase leading-tight mb-1">Snacks<br/>Favoritos</h3>
              <p className="text-xs text-gray-600 dark:text-gray-400 mb-3">Llevando 3 pagás 2</p>
...
function ProductoCard({ producto, backendUrl, onAdd }: { producto: Producto, backendUrl: string, onAdd: any }) {
  ...
  return (
    <div className="bg-white dark:bg-[#1e293b] border border-[#eae6db] dark:border-gray-700 rounded-2xl p-4 flex flex-col justify-between hover:shadow-lg transition-all group">
      <div className="relative aspect-square w-full mb-4 bg-[#fcfbf9] dark:bg-gray-800 rounded-xl overflow-hidden flex items-center justify-center p-2">
        {producto.oferta && (
          <span className="absolute top-2 right-2 bg-[#d8eed9] dark:bg-[#1a4d24] text-[#2e6b36] dark:text-[#6ba368] text-[10px] font-bold px-2 py-1 rounded-md z-10">
            OFERTA
          </span>
        )}
        {producto.imagenUrl ? (
        ...
        className={`w-full py-2.5 rounded-xl font-bold text-xs flex items-center justify-center gap-2 transition-all ${
          producto.stock <= 0 
            ...
            : agregado 
              ...
              : 'bg-white dark:bg-transparent border border-[#324b3b] dark:border-[#6ba368] text-[#324b3b] dark:text-[#6ba368] hover:bg-[#324b3b] hover:text-white dark:hover:bg-[#6ba368] dark:hover:text-[#0f172a]'
        }`}
      >
